...
// node_modules/svelte-icons/gi/GiHamburgerMenu.svelte
var file = "C:/2DAW/DIW/Web Azarquiel/node_modules/svelte-icons/gi/GiHamburgerMenu.svelte";
function create_default_slot(ctx) {
  ...
  const block = {
    ...
    h: function hydrate() {
      attr_dev(path, "d", "M32 96v64h448V96H32zm0 128v64h448v-64H32zm0 128v64h448v-64H32z");
...
function instance($$self, $$props, $$invalidate) {
  ...
  validate_slots("GiHamburgerMenu", slots, []);
  $$self.$$set = ($$new_props) => {
...
var GiHamburgerMenu = class extends SvelteComponentDev {
  constructor(options) {
    super(options);
    init(this, options, instance, create_fragment, safe_not_equal, {});
    dispatch_dev("SvelteRegisterComponent", {
      component: this,
      tagName: "GiHamburgerMenu",
      options,
      id: create_fragment.name
    });
  }
};
var GiHamburgerMenu_default = GiHamburgerMenu;
export {
  GiHamburgerMenu_default as default
};
//# sourceMappingURL=svelte-icons_gi_GiHamburgerMenu__svelte.js.map
