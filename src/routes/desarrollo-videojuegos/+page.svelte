...
<svelte:head>
  <title>Desarollo de videojuegos</title>
</svelte:head>
  ...
  <div class="d-flex justify-content-center header">
    <div class="col-12 col-md-6 d-flex flex-column justify-content-center">
      <h1 class="h2 text-center">
        Curso de Especialización - Desarrollo de Videojuegos y Realidad Virtual <span
    ...
    >
      <img class="img bounce-in-top" src="/images/controller.svg" alt="Icono del curso" />
    </div>
  </div>
